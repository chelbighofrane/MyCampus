...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NosPizzasPageModule", function() { return NosPizzasPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__nos_pizzas__ = __webpack_require__(895);
...
var NosPizzasPageModule = (function () {
    function NosPizzasPageModule() {
    }
    NosPizzasPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__nos_pizzas__["a" /* NosPizzasPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__nos_pizzas__["a" /* NosPizzasPage */]),
            ],
        })
    ], NosPizzasPageModule);
    return NosPizzasPageModule;
}());

//# sourceMappingURL=nos-pizzas.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NosPizzasPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
...
/**
 * Generated class for the NosPizzasPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var NosPizzasPage = (function () {
    function NosPizzasPage(navCtrl, navParams, product, toast, camera, events) {
    ...
    NosPizzasPage.prototype.setupSideMenuContent = function () {
        this.events.publish('sideMenu:changeContent', this.sideMenuContent);
    };
    NosPizzasPage.prototype.ngOnInit = function () {
        var _this = this;
        this.length = 0;
        this.fab = false;
        this.sale = false;
        this.product
            ...
            for (var i = 0; i < _this.products.length; i++) {
                if (_this.products[i].category !== "fastfood" || _this.products[i].type !== "pizza") {
    ...
    NosPizzasPage.prototype.accordionClick = function (event, index, p) {
        console.log(event);
        console.log(index);
        this.photo = p.photo;
    ...
    NosPizzasPage.prototype.ionViewDidLoad = function () {
    };
    NosPizzasPage.prototype.addForm = function () {
        this.navCtrl.push("PizzaFormPage");
    };
    NosPizzasPage.prototype.buttonClick = function () {
        this.navCtrl.push("PizzaDetailPage");
    };
    NosPizzasPage.prototype.onNewItem = function (id) {
        this.navCtrl.push("PizzaFormPage", { id: id });
    };
    NosPizzasPage.prototype.toggleGroup = function (group) {
    ...
    ;
    NosPizzasPage.prototype.isGroupShown = function (group) {
        return this.shownGroup === group;
    };
    ;
    NosPizzasPage.prototype.testfab = function () {
        this.fab = !this.fab;
    };
    NosPizzasPage.prototype.onRemove = function (p) {
        var _this = this;
        this.product.remove(p).then(function () {
            _this.toast.show(p.name + " supprime avec succes!");
            _this.navCtrl.setRoot('NosPizzasPage');
        });
    };
    NosPizzasPage.prototype.onSale = function () {
        this.sale = !this.sale;
        console.log('Cucumbers new state:' + this.promotion);
    };
    NosPizzasPage.prototype.takePic = function (p) {
        var _this = this;
        var options1 = {
            quality: 100,
    ...
    return NosPizzasPage;
}());

//# sourceMappingURL=nos-pizzas.js.map
