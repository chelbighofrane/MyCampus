...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ColdDrinksPageModule", function() { return ColdDrinksPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cold_drinks__ = __webpack_require__(890);
...
var ColdDrinksPageModule = (function () {
    function ColdDrinksPageModule() {
    }
    ColdDrinksPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__cold_drinks__["a" /* ColdDrinksPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__cold_drinks__["a" /* ColdDrinksPage */]),
            ],
        })
    ], ColdDrinksPageModule);
    return ColdDrinksPageModule;
}());

//# sourceMappingURL=cold-drinks.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ColdDrinksPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
...
/**
 * Generated class for the ColdDrinksPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var ColdDrinksPage = (function () {
    function ColdDrinksPage(navCtrl, navParams, product, toast, camera, events) {
        ...
        this.sideMenuContent = [
            ...
            /* {name: 'Nos Pizzas', path: 'NosPizzasPage'},
             {name: 'Nos Sandwichs ', path: 'NosSandwichsPage'},
             {name: 'Nos Supplements ', path: 'NosSupplementsPage'},
             {name: 'Nos Boissons Chaudes ', path: 'HotDrinksPage'},
             {name: 'Nos Boissons Froides ', path: 'ColdDrinksPage'},
             {name: 'Eau ', path: 'WaterPage'},
             {name: 'Nos Vinnoiseries ', path: 'ViennoiseriePage'},
             {name: 'Nos Divers ', path: 'SnacksPage'}*/
        ];
        this.products = [];
        this.shownGroup = null;
        this.setupSideMenuContent();
    }
    ColdDrinksPage.prototype.setupSideMenuContent = function () {
        this.events.publish('sideMenu:changeContent', this.sideMenuContent);
    };
    ColdDrinksPage.prototype.ngOnInit = function () {
        var _this = this;
        this.length = 0;
        this.fab = false;
        this.sale = false;
        this.product
            ...
            for (var i = 0; i < _this.products.length; i++) {
                if (_this.products[i].category !== "boissons" || _this.products[i].type !== "froide") {
    ...
    ColdDrinksPage.prototype.accordionClick = function (event, index, p) {
        console.log(event);
        console.log(index);
        if (p.photo !== null) {
            this.photo = p.photo;
    ...
    ColdDrinksPage.prototype.ionViewDidLoad = function () {
    };
    ColdDrinksPage.prototype.onNewItem = function (id) {
        this.navCtrl.push("FormDrinksPage", { id: id });
    };
    ColdDrinksPage.prototype.toggleGroup = function (group) {
    ...
    ;
    ColdDrinksPage.prototype.isGroupShown = function (group) {
        return this.shownGroup === group;
    };
    ;
    ColdDrinksPage.prototype.testfab = function () {
        this.fab = !this.fab;
    };
    ColdDrinksPage.prototype.onRemove = function (p) {
        var _this = this;
        this.product.remove(p).then(function () {
            _this.toast.show(p.name + " supprime avec succes!");
            _this.navCtrl.setRoot('ColdDrinksPage');
        });
    };
    ColdDrinksPage.prototype.onSale = function () {
        this.sale = !this.sale;
        console.log('Cucumbers new state:' + this.promotion);
    };
    ColdDrinksPage.prototype.takePic = function () {
        var _this = this;
        var options1 = {
            quality: 100,
    ...
    ColdDrinksPage.prototype.onEditItem = function (p) {
        if (this.photo != null) {
            p.photo = this.photo;
        }
        this.product.editItem(p);
        this.toast.show(p.name + " modifie avec succes!");
        this.navCtrl.setRoot('ColdDrinksPage');
    };
    ColdDrinksPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-cold-drinks',template:/*ion-inline-start:"C:\Users\ghofrane\Desktop\ionicTest\MyCampus-master\MyCampus-master\src\pages\cafeteria\cold-drinks\cold-drinks.html"*/'<!--\n  Generated template for the NosPizzasPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar hideBackButton color="primary">\n      <ion-title>Nos Boissons Froides</ion-title>\n      <button ion-button icon-only menuToggle>\n          <ion-icon name="menu"></ion-icon>\n      </button>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding class="arriere">\n  <ion-fab top middle right>\n      <button class="btnt" ion-fab (click)="onNewItem(2)">\n          <ion-icon name="add"></ion-icon>\n      </button>\n  </ion-fab>\n  <ion-list>\n      <div *ngFor="let p of products; let i = index;">\n          <button class="accordion" (click)="accordionClick($event,i,p)">\n              <ion-item-sliding #slidingItem class="k">\n                  <ion-item class="k">\n                      {{p.name}}\n                  </ion-item>\n                  <ion-item-options side="right" class="item-inner">\n                      <button ion-button color="danger" (click)="onRemove(p)" class="btnEsp">\n                          <ion-icon name="trash"></ion-icon>\n                      </button>\n                  </ion-item-options>\n              </ion-item-sliding>\n          </button>\n\n          <div class="panel">\n              <span>\n                  <ion-buttons end="">\n                      <button ion-button icon-only clear (click)="takePic()">\n                          <ion-icon name="camera"></ion-icon>\n                      </button>\n                  </ion-buttons>\n              </span>\n              <form #f="ngForm" class="login-box" (ngSubmit)="onEditItem(p)">\n                  <p class="article-content ">\n                      <span class="titre"> Libelle: </span>\n                      <input class="input" type="text" name="name" [(ngModel)]="p.name" placeholder={{p.name}} required="">\n                  </p>\n\n                  <p class="article-content ">\n                      <span class="titre">Description:</span>\n                      <br>\n                      <span>\n\n                          <textarea class="input" cols="50" name="description" [(ngModel)]="p.description" placeholder={{p.description}} required=""></textarea>\n                      </span>\n                  </p>\n\n                  <p class="article-content ">\n                      <span class="titre"> Prix: </span>\n                      <input class="input" s type="number" name="price" [(ngModel)]="p.price" placeholder={{p.price}} required="">\n                  </p>\n\n                  <p class="article-content " >\n                      <span class="titre" *ngIf="p.photo!=\'vide\'">Photo:</span>\n                      <div class="divPhoto" *ngIf="p.photo!=\'vide\'">\n                          <img src="{{this.photo}}" />\n                      </div>\n\n\n                      <p class="article-content ">\n                          <ion-checkbox name="onSale" [(ngModel)]="p.onSale" checked="p.onSale" (click)="onSale()"></ion-checkbox>\n                          &nbsp;\n\n                          <span class="titre">Promotion</span>\n                      </p>\n                      <p class="article-content" *ngIf="p.onSale">\n                          <span class="marge">Nouveau:</span>\n                          <input class="input" type="number" name="priceOnSale" [(ngModel)]="p.priceOnSale" placeholder={{p.priceOnSale}} required="">\n                      </p>\n                      <p class="article-content" *ngIf="p.onSale">\n                          <span class="margeChar2">Debut:</span>\n                          &nbsp;\n                          <input class="input" onfocus="(this.type=\'date\')" name="startDate" [(ngModel)]="p.startDate" placeholder={{p.startDate|date}}\n                              required="">\n                      </p>\n                      <p class="article-content" *ngIf="p.onSale">\n                          <span class="margeChar1">Fin:</span>\n                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n                          <input class="input" onfocus="(this.type=\'date\')" name="endDate" [(ngModel)]="p.endDate" placeholder={{p.endDate|date}} required="">\n                      </p>\n                      <br>\n\n                      <button class="btnt" ion-button="" type="submit" block="" [disabled]="!f.valid">Sauvegarder</button>\n                      <br>\n              </form>\n          </div>\n      </div>\n\n\n  </ion-list>\n\n\n</ion-content>'/*ion-inline-end:"C:\Users\ghofrane\Desktop\ionicTest\MyCampus-master\MyCampus-master\src\pages\cafeteria\cold-drinks\cold-drinks.html"*/,
        }),
    ...
    return ColdDrinksPage;
}());

//# sourceMappingURL=cold-drinks.js.map
