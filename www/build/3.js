...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__coming_events__ = __webpack_require__(929);
...
var ComingEventsPageModule = (function () {
    ...
    ComingEventsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__coming_events__["a" /* ComingEventsPage */]),
            ],
        })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_create_event_modal_create_event_modal_component__ = __webpack_require__(380);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_event_details_modal_event_details_modal_component__ = __webpack_require__(376);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_feedback_modal_feedback_modal_component__ = __webpack_require__(377);
...
var ComingEventsPage = (function () {
    function ComingEventsPage(navCtrl, navParams, modalCtrl, clubService) {
    ...
    ComingEventsPage.prototype.ngOnInit = function () {
        ...
        if (!this.clubKey || this.clubKey === undefined) {
            ...
            this.isAdmin = false;
            this.clubService.getClubById(this.clubKey).subscribe(function (club) {
                _this.club = club;
                _this.getComingEvents();
            }, function (error) {
                console.log(error);
    ...
    ComingEventsPage.prototype.getComingEvents = function () {
        var _this = this;
        this.club.events.forEach(function (event) {
            var endEventMoment = __WEBPACK_IMPORTED_MODULE_2_moment__(event.endDate + " " + event.endTime, 'YYYY-MM-DD HH:mm');
            if (endEventMoment.isAfter(__WEBPACK_IMPORTED_MODULE_2_moment__())) {
                _this.comingEvents.push(JSON.parse(JSON.stringify(event)));
            }
        });
    };
    ComingEventsPage.prototype.presentFeedbackModal = function (event, index) {
        event.stopPropagation();
        var feedbackModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_6__components_feedback_modal_feedback_modal_component__["a" /* FeedbackModalComponent */], { clubKey: this.club.key, eventKey: this.club.events[index].key, isAdmin: this.isAdmin });
        feedbackModal.present();
    };
    ComingEventsPage.prototype.presentDetailsModal = function (index) {
        var detailsModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_5__components_event_details_modal_event_details_modal_component__["a" /* EventDetailsModalComponent */], { clubKey: this.club.key, eventKey: this.club.events[index].key, isAdmin: this.isAdmin });
        detailsModal.present();
    };
    ComingEventsPage.prototype.presentCreatEventModal = function () {
        var creatEventModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_4__components_create_event_modal_create_event_modal_component__["a" /* CreateEventModalComponent */]);
        creatEventModal.present();
    };
    ComingEventsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-coming-events',template:/*ion-inline-start:"C:\Users\ghofrane\Desktop\ionicTest\MyCampus-master\MyCampus-master\src\pages\club\coming-events\coming-events.html"*/'<ion-header>\n\n    <ion-navbar hideBackButton color="primary">\n\n        <button ion-button icon-only menuToggle>\n            <ion-icon name="menu"></ion-icon>\n        </button>\n\n        <ion-title>Événements</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n    <section *ngIf="comingEvents && comingEvents.length > 0" id="coming-events-section" padding>\n\n        <div *ngFor="let event of comingEvents; let i = index;" class="event-card" (click)="presentDetailsModal(i)">\n            <div class="event-card-cover" [ngStyle]="{\'background\':\'url(\'+event.mainPhoto+\')\'}">\n                \n            </div>\n            <div class="event-card-details">\n                <p class="event-title">{{event.name}}</p>\n                <div *ngIf="event.tags && event.tags.length > 0" class="tags-container">\n                    <div *ngFor="let tag of event.tags" class="tag">\n                        <span class="tag-label">{{tag}}</span>\n                    </div>\n                </div>\n                <p class="event-detail"><span class="logo-container"><i class="far fa-calendar-alt"></i></span>{{event.startDate}} - {{event.startTime}}</p>\n                <p class="event-detail"><span class="logo-container"><i class="fas fa-map-marker-alt"></i></span>{{event.location.name}}</p>\n            </div>\n            <div class="event-card-footer">\n                <ion-item>\n                    <button *ngIf="event.interested && event.interested.length > 0" ion-button clear item-start>{{event.interested.length}} Intéressés</button>\n                    <button ion-button clear item-end (click)="presentFeedbackModal($event, i)">Feedback</button>\n                </ion-item>\n            </div>\n        </div>\n\n    </section>\n\n    <ion-fab *ngIf="isAdmin" right bottom>\n        <button ion-fab color="secondary" (click)="presentCreatEventModal()"><ion-icon name="add"></ion-icon></button>\n    </ion-fab>\n\n</ion-content>'/*ion-inline-end:"C:\Users\ghofrane\Desktop\ionicTest\MyCampus-master\MyCampus-master\src\pages\club\coming-events\coming-events.html"*/,
        }),
