...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SnacksPageModule", function() { return SnacksPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__snacks__ = __webpack_require__(899);
...
var SnacksPageModule = (function () {
    function SnacksPageModule() {
    }
    SnacksPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__snacks__["a" /* SnacksPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__snacks__["a" /* SnacksPage */]),
            ],
        })
    ], SnacksPageModule);
    return SnacksPageModule;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SnacksPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
 ...
 */
var SnacksPage = (function () {
    function SnacksPage(navCtrl, navParams, product, toast, camera, events) {
    ...
    SnacksPage.prototype.setupSideMenuContent = function () {
        this.events.publish('sideMenu:changeContent', this.sideMenuContent);
    };
    SnacksPage.prototype.ngOnInit = function () {
        var _this = this;
        this.length = 0;
        this.fab = false;
        this.sale = false;
        this.product
            ...
            for (var i = 0; i < _this.products.length; i++) {
                if (_this.products[i].category !== "autre" || _this.products[i].type !== "snack") {
    ...
    SnacksPage.prototype.accordionClick = function (event, index, p) {
        console.log(event);
        console.log(index);
        if (p.photo !== null) {
            this.photo = p.photo;
    ...
    SnacksPage.prototype.ionViewDidLoad = function () {
    };
    SnacksPage.prototype.onNewItem = function (id) {
        this.navCtrl.push("FormDrinksPage", { id: id });
    };
    SnacksPage.prototype.toggleGroup = function (group) {
    ...
    ;
    SnacksPage.prototype.isGroupShown = function (group) {
        return this.shownGroup === group;
    };
    ;
    SnacksPage.prototype.testfab = function () {
        this.fab = !this.fab;
    };
    SnacksPage.prototype.onRemove = function (p) {
        var _this = this;
        this.product.remove(p).then(function () {
            _this.toast.show(p.name + " supprime avec succes!");
            _this.navCtrl.setRoot('SnacksPage');
        });
    };
    SnacksPage.prototype.onSale = function () {
        this.sale = !this.sale;
        console.log('Cucumbers new state:' + this.promotion);
    };
    SnacksPage.prototype.takePic = function () {
        var _this = this;
        var options1 = {
            quality: 100,
