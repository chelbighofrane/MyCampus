...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NosSupplementsPageModule", function() { return NosSupplementsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__nos_supplements__ = __webpack_require__(897);
...
var NosSupplementsPageModule = (function () {
    function NosSupplementsPageModule() {
    }
    NosSupplementsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__nos_supplements__["a" /* NosSupplementsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__nos_supplements__["a" /* NosSupplementsPage */]),
            ],
        })
    ], NosSupplementsPageModule);
    return NosSupplementsPageModule;
}());

//# sourceMappingURL=nos-supplements.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NosSupplementsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
...
/**
 * Generated class for the NosSupplementsPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var NosSupplementsPage = (function () {
    function NosSupplementsPage(navCtrl, navParams, product, toast, camera, events) {
    ...
    NosSupplementsPage.prototype.setupSideMenuContent = function () {
        this.events.publish('sideMenu:changeContent', this.sideMenuContent);
    };
    NosSupplementsPage.prototype.ngOnInit = function () {
        var _this = this;
        this.length = 0;
        this.fab = false;
        this.sale = false;
    ...
    NosSupplementsPage.prototype.accordionClick = function (event, index, p) {
        console.log(event);
        console.log(index);
        this.photo = p.photo;
    ...
    NosSupplementsPage.prototype.ionViewDidLoad = function () {
    };
    NosSupplementsPage.prototype.addForm = function () {
        this.navCtrl.push("PizzaFormPage");
    };
    NosSupplementsPage.prototype.buttonClick = function () {
        this.navCtrl.push("PizzaDetailPage");
    };
    NosSupplementsPage.prototype.onNewItem = function (id) {
        this.navCtrl.push("PizzaFormPage", { id: id });
        console.log(id);
    };
    NosSupplementsPage.prototype.toggleGroup = function (group) {
    ...
    ;
    NosSupplementsPage.prototype.isGroupShown = function (group) {
        return this.shownGroup === group;
    };
    ;
    NosSupplementsPage.prototype.testfab = function () {
        this.fab = !this.fab;
    };
    NosSupplementsPage.prototype.onRemove = function (p) {
        var _this = this;
        this.product.remove(p).then(function () {
            _this.toast.show(p.name + " supprime avec succes!");
            _this.navCtrl.setRoot('NosSupplementsPage');
        });
    };
    NosSupplementsPage.prototype.onSale = function () {
        this.sale = !this.sale;
        console.log('Cucumbers new state:' + this.promotion);
    };
    NosSupplementsPage.prototype.takePic = function () {
        var _this = this;
        var options1 = {
            quality: 100,
    ...
    NosSupplementsPage.prototype.onEditItem = function (p) {
        if (this.photo != null) {
            p.photo = this.photo;
        }
    ...
    return NosSupplementsPage;
}());

//# sourceMappingURL=nos-supplements.js.map
