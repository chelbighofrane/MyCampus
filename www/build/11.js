...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NosSandwichsPageModule", function() { return NosSandwichsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__nos_sandwichs__ = __webpack_require__(896);
...
var NosSandwichsPageModule = (function () {
    function NosSandwichsPageModule() {
    }
    NosSandwichsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__nos_sandwichs__["a" /* NosSandwichsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__nos_sandwichs__["a" /* NosSandwichsPage */]),
            ],
        })
    ], NosSandwichsPageModule);
    return NosSandwichsPageModule;
}());

//# sourceMappingURL=nos-sandwichs.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NosSandwichsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
 ...
 */
var NosSandwichsPage = (function () {
    function NosSandwichsPage(navCtrl, navParams, product, toast, camera, events) {
    ...
    NosSandwichsPage.prototype.setupSideMenuContent = function () {
        this.events.publish('sideMenu:changeContent', this.sideMenuContent);
    };
    NosSandwichsPage.prototype.ngOnInit = function () {
        var _this = this;
        this.length = 0;
        this.fab = false;
        this.sale = false;
        this.product
            ...
            for (var i = 0; i < _this.products.length; i++) {
                if (_this.products[i].category !== 'fastfood' || _this.products[i].type !== 'sandwich') {
    ...
    NosSandwichsPage.prototype.accordionClick = function (event, index, p) {
        console.log(event);
        console.log(index);
        this.photo = p.photo;
    ...
    NosSandwichsPage.prototype.ionViewDidLoad = function () {
    };
    NosSandwichsPage.prototype.addForm = function () {
        this.navCtrl.push("PizzaFormPage");
    };
    NosSandwichsPage.prototype.buttonClick = function () {
        this.navCtrl.push("PizzaDetailPage");
    };
    NosSandwichsPage.prototype.onNewItem = function (id) {
        this.navCtrl.push("PizzaFormPage", { id: id });
    };
    NosSandwichsPage.prototype.toggleGroup = function (group) {
    ...
    ;
    NosSandwichsPage.prototype.isGroupShown = function (group) {
        return this.shownGroup === group;
    };
    ;
    NosSandwichsPage.prototype.onRemove = function (p) {
        var _this = this;
        this.product.remove(p).then(function () {
            _this.toast.show(p.name + " supprime avec succes!");
            _this.navCtrl.setRoot('NosSandwichsPage');
        });
    };
    NosSandwichsPage.prototype.onSale = function () {
        this.sale = !this.sale;
        console.log('Cucumbers new state:' + this.promotion);
    };
    NosSandwichsPage.prototype.takePic = function () {
        var _this = this;
        var options1 = {
            quality: 100,
        ...
        this.camera.getPicture(options1)
            ...
            __WEBPACK_IMPORTED_MODULE_5_firebase___default.a.storage().ref("product/" + filename + ".jpg").putString(_this.photo, 'data_url').then(function (img) { _this.mine = img.downloadURL; });
        });
        this.photo = this.mine;
    };
    NosSandwichsPage.prototype.onEditItem = function (p) {
        if (this.photo != null) {
            p.photo = this.photo;
        }
        this.photo = this.mine;
    ...
    return NosSandwichsPage;
}());

//# sourceMappingURL=nos-sandwichs.js.map
