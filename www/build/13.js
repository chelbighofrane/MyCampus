...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HotDrinksPageModule", function() { return HotDrinksPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__hot_drinks__ = __webpack_require__(894);
...
var HotDrinksPageModule = (function () {
    function HotDrinksPageModule() {
    }
    HotDrinksPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__hot_drinks__["a" /* HotDrinksPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__hot_drinks__["a" /* HotDrinksPage */]),
            ],
        })
    ], HotDrinksPageModule);
    return HotDrinksPageModule;
}());

//# sourceMappingURL=hot-drinks.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HotDrinksPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
...
/**
 * Generated class for the HotDrinksPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var HotDrinksPage = (function () {
    function HotDrinksPage(navCtrl, navParams, product, toast, camera, events) {
    ...
    HotDrinksPage.prototype.setupSideMenuContent = function () {
        this.events.publish('sideMenu:changeContent', this.sideMenuContent);
    };
    HotDrinksPage.prototype.ngOnInit = function () {
        var _this = this;
        this.length = 0;
        this.fab = false;
        this.sale = false;
        this.product
            ...
            for (var i = 0; i < _this.products.length; i++) {
                if (_this.products[i].category !== "boissons" || _this.products[i].type !== "chaude") {
    ...
    HotDrinksPage.prototype.accordionClick = function (event, index, p) {
        console.log(event);
        console.log(index);
        if (p.photo !== null) {
            this.photo = p.photo;
    ...
    HotDrinksPage.prototype.ionViewDidLoad = function () {
    };
    HotDrinksPage.prototype.addForm = function () {
        this.navCtrl.push("PizzaFormPage");
    };
    HotDrinksPage.prototype.buttonClick = function () {
        this.navCtrl.push("PizzaDetailPage");
    };
    HotDrinksPage.prototype.onNewItem = function (id) {
        this.navCtrl.push("FormDrinksPage", { id: id });
    };
    HotDrinksPage.prototype.toggleGroup = function (group) {
    ...
    ;
    HotDrinksPage.prototype.isGroupShown = function (group) {
        return this.shownGroup === group;
    };
    ;
    HotDrinksPage.prototype.testfab = function () {
        this.fab = !this.fab;
    };
    HotDrinksPage.prototype.onRemove = function (p) {
        var _this = this;
        this.product.remove(p).then(function () {
            _this.toast.show(p.name + " supprime avec succes!");
            _this.navCtrl.setRoot('HotDrinksPage');
        });
    };
    HotDrinksPage.prototype.onSale = function () {
        this.sale = !this.sale;
        console.log('Cucumbers new state:' + this.promotion);
    };
    HotDrinksPage.prototype.takePic = function () {
        var _this = this;
        var options1 = {
            quality: 100,
...
//# sourceMappingURL=hot-drinks.js.map
