...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PizzaFormPageModule", function() { return PizzaFormPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pizza_form__ = __webpack_require__(898);
...
var PizzaFormPageModule = (function () {
    function PizzaFormPageModule() {
    }
    PizzaFormPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__pizza_form__["a" /* PizzaFormPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__pizza_form__["a" /* PizzaFormPage */]),
            ],
        })
    ], PizzaFormPageModule);
    return PizzaFormPageModule;
}());

//# sourceMappingURL=pizza-form.module.js.map
...
var PizzaFormPage = (function () {
    function PizzaFormPage(navCtrl, navParams, product, toast, camera, alertCtrl) {
    ...
    PizzaFormPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad PizzaFormPage');
        console.log(this.mineStat);
    };
    PizzaFormPage.prototype.onSale = function () {
        this.sale = !this.sale;
        console.log('Cucumbers new state:' + this.promotion);
    };
    PizzaFormPage.prototype.onAddItem = function (p) {
        var _this = this;
        if (p.onSale == null) {
            p.onSale = false;
        }
        ...
        this.product.addItem(p).then(function (ref) {
            ...
            _this.navCtrl.setRoot('NosPizzasPage', { key: ref.key });
        });
    };
    PizzaFormPage.prototype.onAddSandwich = function (p) {
        var _this = this;
        if (p.onSale == null) {
            p.onSale = false;
        }
        ...
        if (this.mine != null) {
            ...
            p.photo = "assets/imgs/assets/imgs/vide.pnge.png";
            console.log("g pas une photo");
        }
        this.product.addItem(p).then(function (ref) {
            _this.toast.show(p.name + " ajoute avec succes!");
            _this.navCtrl.setRoot('NosSandwichsPage', { key: ref.key });
        });
    };
    PizzaFormPage.prototype.onAddSupplement = function (p) {
        var _this = this;
        if (p.onSale == null) {
            p.onSale = false;
        }
        ...
        this.product.addItem(p).then(function (ref) {
            _this.toast.show(p.name + " ajoute avec succes!");
            _this.navCtrl.setRoot('NosSupplementsPage', { key: ref.key });
        });
    };
    PizzaFormPage.prototype.takePic = function () {
        var _this = this;
        this.mineStat = true;
        var options1 = {
            quality: 100,
        ...
        this.camera.getPicture(options1)
            ...
            if (_this.id == 1) {
                __WEBPACK_IMPORTED_MODULE_5_firebase___default.a.storage().ref("product/fastfood/Pizzas/" + filename + ".jpg").putString(_this.photo, 'data_url').then(function (img) { _this.mine = img.downloadURL; });
            }
            else if (_this.id == 2) {
                __WEBPACK_IMPORTED_MODULE_5_firebase___default.a.storage().ref("product/fastfood/Sandwitchs/" + filename + ".jpg").putString(_this.photo, 'data_url').then(function (img) { _this.mine = img.downloadURL; });
            }
            else {
                __WEBPACK_IMPORTED_MODULE_5_firebase___default.a.storage().ref("product/fastfood/Supplements/" + filename + ".jpg").putString(_this.photo, 'data_url').then(function (img) { _this.mine = img.downloadURL; });
            }
        });
    };
    PizzaFormPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-pizza-form',template:/*ion-inline-start:"C:\Users\ghofrane\Desktop\ionicTest\MyCampus-master\MyCampus-master\src\pages\cafeteria\pizza-form\pizza-form.html"*/'<!--\n  Generated template for the PizzaFormPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n    <ion-navbar color="primary">\n      <ion-title>Ajout</ion-title>\n      <ion-buttons end>\n        <button ion-button icon-only (click)="takePic()">\n          <ion-icon name="camera"></ion-icon>\n        </button>\n      </ion-buttons>\n\n    </ion-navbar>\n  </ion-header>\n\n\n<ion-content *ngIf="id==1" overflow-scroll="true" padding class="bgPizzas">\n    <form #f="ngForm" class="login-box" (ngSubmit)="onAddItem(f.value)">\n        <ion-item class="item">\n            <ion-label floating>Libelle</ion-label>\n            <ion-input  type="text" name="name"  [(ngModel)]="p.name" required="" ></ion-input>\n        </ion-item>\n        <ion-item>\n            <ion-label floating>Description</ion-label>\n            <ion-textarea   type="" name="description"  [(ngModel)]="p.description" required="" ></ion-textarea >\n        </ion-item>\n        <ion-item>\n            <ion-label floating>Prix</ion-label>\n            <ion-input  type="number" name="price"  [(ngModel)]="p.price"   required="" ></ion-input>\n        </ion-item>\n        <ion-item >\n            <ion-label >Photo</ion-label>\n                \n            </ion-item>\n            <div class="divPhoto" *ngIf="p.photo!=\'assets/imgs/vide.png\'">\n                <img src="{{mine}}" *ngIf="p.photo!=\'assets/imgs/vide.png\'"/>\n            </div>\n            \n        <ion-item>\n            <ion-label class="item">Promotion</ion-label>\n            <ion-checkbox name="onSale" [(ngModel)]="p.onSale" checked="p.onSale"  (click)="onSale()" ></ion-checkbox>\n        </ion-item>\n        <div *ngIf="p.onSale">\n        <ion-item >\n            <ion-label floating>Nouveau</ion-label>\n            <ion-input type="number" name="priceOnSale"  [(ngModel)]="p.priceOnSale"  required="" ></ion-input>\n        </ion-item>\n        <ion-item >\n            <ion-label floating>Debut</ion-label>\n            <ion-datetime displayFormat="MMM DD, YYYY" name="startDate" [(ngModel)]="p.startDate"  ></ion-datetime>\n        </ion-item>\n        <ion-item >\n                <ion-label floating>fin</ion-label>\n            <ion-datetime   displayFormat="MMM DD, YYYY" name="endDate"  [(ngModel)]="p.endDate"  ></ion-datetime>\n        </ion-item>\n        </div>\n        \n                \n            <br><br>\n        <button class="btnt" ion-button="" type="submit"  block="" [disabled]="!f.valid">Ajouter</button>\n      </form>\n\n      \n\n</ion-content>\n\n<ion-content *ngIf="id==2" overflow-scroll="true" padding class="bgSandwich">\n    <form #f="ngForm" class="login-box" (ngSubmit)="onAddSandwich(f.value)">\n        <ion-item class="item">\n            <ion-label floating>Libelle</ion-label>\n            <ion-input  type="text" name="name"  [(ngModel)]="p.name" required="" ></ion-input>\n        </ion-item>\n        <ion-item>\n            <ion-label floating>Description</ion-label>\n            <ion-textarea   type="" name="description"  [(ngModel)]="p.description" required="" ></ion-textarea >\n        </ion-item>\n        <ion-item>\n            <ion-label floating>Prix</ion-label>\n            <ion-input  type="number" name="price"  [(ngModel)]="p.price"   required="" ></ion-input>\n        </ion-item>\n        <ion-item *ngIf="this.mineStat==true">\n            <ion-label>Photo</ion-label>\n            <div class="divPhoto" >\n                <img src="{{mine}}"/>\n            </div>\n        </ion-item>   \n        <ion-item>\n            <ion-label class="item">Promotion</ion-label>\n            <ion-checkbox name="onSale" [(ngModel)]="p.onSale" checked="p.onSale"  (click)="onSale()" ></ion-checkbox>\n        </ion-item>\n        <div *ngIf="p.onSale">\n        <ion-item >\n            <ion-label floating>Nouveau</ion-label>\n            <ion-input type="number" name="priceOnSale"  [(ngModel)]="p.priceOnSale"  required="" ></ion-input>\n        </ion-item>\n        <ion-item >\n            <ion-label floating>Debut</ion-label>\n            <ion-datetime displayFormat="MMM DD, YYYY" name="startDate" [(ngModel)]="p.startDate"  ></ion-datetime>\n        </ion-item>\n        <ion-item >\n                <ion-label floating>fin</ion-label>\n            <ion-datetime   displayFormat="MMM DD, YYYY" name="endDate"  [(ngModel)]="p.endDate"  ></ion-datetime>\n        </ion-item>\n        </div>\n        \n                \n            <br><br>\n        <button class="btnt" ion-button="" type="submit"  block="" [disabled]="!f.valid">Ajouter</button>\n      </form>\n\n      \n\n</ion-content>\n\n<ion-content *ngIf="id==3" overflow-scroll="true" padding class="bgSupplements">\n    <form #f="ngForm" class="login-box" (ngSubmit)="onAddSupplement(f.value)">\n        <ion-item class="item">\n            <ion-label floating>Libelle</ion-label>\n            <ion-input  type="text" name="name"  [(ngModel)]="p.name" required="" ></ion-input>\n        </ion-item>\n        <ion-item>\n            <ion-label floating>Prix</ion-label>\n            <ion-input  type="number" name="price"  [(ngModel)]="p.price"   required="" ></ion-input>\n        </ion-item>\n        <ion-item >\n            <ion-label>Photo</ion-label>\n                \n            </ion-item>\n            <div class="divPhoto">\n                <img src="{{mine}}"/>\n            </div>\n            \n        <ion-item>\n            <ion-label class="item">Promotion</ion-label>\n            <ion-checkbox name="onSale" [(ngModel)]="p.onSale" checked="p.onSale"  (click)="onSale()" ></ion-checkbox>\n        </ion-item>\n        <div *ngIf="p.onSale">\n        <ion-item >\n            <ion-label floating>Nouveau</ion-label>\n            <ion-input type="number" name="priceOnSale"  [(ngModel)]="p.priceOnSale"  required="" ></ion-input>\n        </ion-item>\n        <ion-item >\n            <ion-label floating>Debut</ion-label>\n            <ion-datetime displayFormat="MMM DD, YYYY" name="startDate" [(ngModel)]="p.startDate"  ></ion-datetime>\n        </ion-item>\n        <ion-item >\n                <ion-label floating>fin</ion-label>\n            <ion-datetime   displayFormat="MMM DD, YYYY" name="endDate"  [(ngModel)]="p.endDate"  ></ion-datetime>\n        </ion-item>\n        </div>\n        \n                \n            <br><br>\n        <button class="btnt" ion-button="" type="submit"  block="" [disabled]="!f.valid">Ajouter</button>\n      </form>\n\n      \n\n</ion-content>\n'/*ion-inline-end:"C:\Users\ghofrane\Desktop\ionicTest\MyCampus-master\MyCampus-master\src\pages\cafeteria\pizza-form\pizza-form.html"*/,
        }),
