...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FormDrinksPageModule", function() { return FormDrinksPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__form_drinks__ = __webpack_require__(892);
...
var FormDrinksPageModule = (function () {
    function FormDrinksPageModule() {
    }
    FormDrinksPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__form_drinks__["a" /* FormDrinksPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__form_drinks__["a" /* FormDrinksPage */]),
            ],
        })
    ], FormDrinksPageModule);
    return FormDrinksPageModule;
}());

//# sourceMappingURL=form-drinks.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FormDrinksPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_firebase__ = __webpack_require__(684);
 ...
 */
var FormDrinksPage = (function () {
    function FormDrinksPage(navCtrl, navParams, product, toast, camera, alertCtrl) {
    ...
    FormDrinksPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad PizzaFormPage');
        console.log(this.mineStat);
    };
    FormDrinksPage.prototype.onSale = function () {
        this.sale = !this.sale;
        console.log('Cucumbers new state:' + this.promotion);
    };
    FormDrinksPage.prototype.onAddItem = function (p) {
        var _this = this;
        if (p.onSale == null) {
            p.onSale = false;
        }
        ...
        if (this.mine != null) {
            ...
            p.photo = "assets/imgs/vide.png";
            console.log("g pas une photo");
        }
        this.product.addItem(p).then(function (ref) {
            _this.toast.show(p.name + " ajoute avec succes!");
            _this.navCtrl.setRoot('HotDrinksPage', { key: ref.key });
        });
    };
    FormDrinksPage.prototype.onAddCold = function (p) {
        var _this = this;
        if (p.onSale == null) {
            p.onSale = false;
        }
        ...
        this.product.addItem(p).then(function (ref) {
            _this.toast.show(p.name + " ajoute avec succes!");
            _this.navCtrl.setRoot('ColdDrinksPage', { key: ref.key });
        });
    };
    FormDrinksPage.prototype.onAddWater = function (p) {
        var _this = this;
        if (p.onSale == null) {
            p.onSale = false;
        }
        ...
        this.product.addItem(p).then(function (ref) {
            _this.toast.show(p.name + " ajoute avec succes!");
            _this.navCtrl.setRoot('WaterPage', { key: ref.key });
        });
    };
    FormDrinksPage.prototype.onAddSnack = function (p) {
        var _this = this;
        if (p.onSale == null) {
            p.onSale = false;
        }
        ...
        this.product.addItem(p).then(function (ref) {
            _this.toast.show(p.name + " ajoute avec succes!");
            _this.navCtrl.setRoot('SnacksPage', { key: ref.key });
        });
    };
    FormDrinksPage.prototype.onAddViennoiserie = function (p) {
        var _this = this;
        if (p.onSale == null) {
            p.onSale = false;
        }
        ...
        this.product.addItem(p).then(function (ref) {
            _this.toast.show(p.name + " ajoute avec succes!");
            _this.navCtrl.setRoot('ViennoiseriePage', { key: ref.key });
        });
    };
    FormDrinksPage.prototype.takePic = function () {
        var _this = this;
        this.mineStat = true;
        var options1 = {
            quality: 100,
        ...
        this.camera.getPicture(options1)
            ...
            if (_this.id == 1) {
                __WEBPACK_IMPORTED_MODULE_5_firebase___default.a.storage().ref("product/boissons/chaudes/" + filename + ".jpg").putString(_this.photo, 'data_url').then(function (img) { _this.mine = img.downloadURL; });
            }
            else if (_this.id == 2) {
                __WEBPACK_IMPORTED_MODULE_5_firebase___default.a.storage().ref("product/boissons/froides/" + filename + ".jpg").putString(_this.photo, 'data_url').then(function (img) { _this.mine = img.downloadURL; });
            }
            else if (_this.id == 3) {
                __WEBPACK_IMPORTED_MODULE_5_firebase___default.a.storage().ref("product/boissons/eau/" + filename + ".jpg").putString(_this.photo, 'data_url').then(function (img) { _this.mine = img.downloadURL; });
            }
            else if (_this.id == 4) {
                __WEBPACK_IMPORTED_MODULE_5_firebase___default.a.storage().ref("product/autre/snacks/" + filename + ".jpg").putString(_this.photo, 'data_url').then(function (img) { _this.mine = img.downloadURL; });
            }
            else {
                __WEBPACK_IMPORTED_MODULE_5_firebase___default.a.storage().ref("product/autre/viennoiseries/" + filename + ".jpg").putString(_this.photo, 'data_url').then(function (img) { _this.mine = img.downloadURL; });
            }
        });
    };
    FormDrinksPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-form-drinks',template:/*ion-inline-start:"C:\Users\ghofrane\Desktop\ionicTest\MyCampus-master\MyCampus-master\src\pages\cafeteria\form-drinks\form-drinks.html"*/'<!--\n  Generated template for the PizzaFormPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>Ajout</ion-title>\n    <ion-buttons end>\n      <button ion-button icon-only (click)="takePic()">\n        <ion-icon name="camera"></ion-icon>\n      </button>\n    </ion-buttons>\n\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content *ngIf="id==1" overflow-scroll="true" padding class="bgHot">\n  <form #f="ngForm" class="login-box" (ngSubmit)="onAddItem(f.value)">\n      <ion-item class="item">\n          <ion-label floating>Libelle</ion-label>\n          <ion-input  type="text" name="name"  [(ngModel)]="p.name" required="" ></ion-input>\n      </ion-item>\n      <ion-item>\n          <ion-label floating>Description</ion-label>\n          <ion-textarea   type="" name="description"  [(ngModel)]="p.description" required="" ></ion-textarea >\n      </ion-item>\n      <ion-item>\n          <ion-label floating>Prix</ion-label>\n          <ion-input  type="number" name="price"  [(ngModel)]="p.price"   required="" ></ion-input>\n      </ion-item>\n      <ion-item *ngIf="this.mineStat">\n          <ion-label >Photo</ion-label>\n              \n          </ion-item>\n          <div class="divPhoto" >\n              <img src="{{mine}}"/>\n          </div>\n          \n      <ion-item>\n          <ion-label class="item">Promotion</ion-label>\n          <ion-checkbox name="onSale" [(ngModel)]="p.onSale" checked="p.onSale"  (click)="onSale()" ></ion-checkbox>\n      </ion-item>\n      <div *ngIf="p.onSale">\n      <ion-item >\n          <ion-label floating>Nouveau</ion-label>\n          <ion-input type="number" name="priceOnSale"  [(ngModel)]="p.priceOnSale"  required="" ></ion-input>\n      </ion-item>\n      <ion-item >\n          <ion-label floating>Debut</ion-label>\n          <ion-datetime displayFormat="MMM DD, YYYY" name="startDate" [(ngModel)]="p.startDate"  ></ion-datetime>\n      </ion-item>\n      <ion-item >\n              <ion-label floating>fin</ion-label>\n          <ion-datetime   displayFormat="MMM DD, YYYY" name="endDate"  [(ngModel)]="p.endDate"  ></ion-datetime>\n      </ion-item>\n      </div>\n      \n              \n          <br><br>\n      <button class="btnt" ion-button="" type="submit"  block="" [disabled]="!f.valid">Ajouter</button>\n    </form>\n\n    \n\n</ion-content>\n\n<ion-content *ngIf="id==2" overflow-scroll="true" padding class="bgCold">\n  <form #f="ngForm" class="login-box" (ngSubmit)="onAddCold(f.value)">\n      <ion-item class="item">\n          <ion-label floating>Libelle</ion-label>\n          <ion-input  type="text" name="name"  [(ngModel)]="p.name" required="" ></ion-input>\n      </ion-item>\n      <ion-item>\n          <ion-label floating>Description</ion-label>\n          <ion-textarea   type="" name="description"  [(ngModel)]="p.description" required="" ></ion-textarea >\n      </ion-item>\n      <ion-item>\n          <ion-label floating>Prix</ion-label>\n          <ion-input  type="number" name="price"  [(ngModel)]="p.price"   required="" ></ion-input>\n      </ion-item>\n      <ion-item *ngIf="p.photo!=\'assets/imgs/vide.png\'" >\n          <ion-label>Photo</ion-label>\n              \n          </ion-item>\n          <div class="divPhoto" *ngIf="p.photo!=\'assets/imgs/vide.png\'">\n              <img src="{{mine}}"/>\n          </div>\n          \n      <ion-item>\n          <ion-label class="item">Promotion</ion-label>\n          <ion-checkbox name="onSale" [(ngModel)]="p.onSale" checked="p.onSale"  (click)="onSale()" ></ion-checkbox>\n      </ion-item>\n      <div *ngIf="p.onSale">\n      <ion-item >\n          <ion-label floating>Nouveau</ion-label>\n          <ion-input type="number" name="priceOnSale"  [(ngModel)]="p.priceOnSale"  required="" ></ion-input>\n      </ion-item>\n      <ion-item >\n          <ion-label floating>Debut</ion-label>\n          <ion-datetime displayFormat="MMM DD, YYYY" name="startDate" [(ngModel)]="p.startDate"  ></ion-datetime>\n      </ion-item>\n      <ion-item >\n              <ion-label floating>fin</ion-label>\n          <ion-datetime   displayFormat="MMM DD, YYYY" name="endDate"  [(ngModel)]="p.endDate"  ></ion-datetime>\n      </ion-item>\n      </div>\n      \n              \n          <br><br>\n      <button class="btnt" ion-button="" type="submit"  block="" [disabled]="!f.valid">Ajouter</button>\n    </form>\n\n    \n\n</ion-content>\n\n<ion-content *ngIf="id==3" overflow-scroll="true" padding class="bgWater">\n  <form #f="ngForm" class="login-box" (ngSubmit)="onAddWater(f.value)">\n      <ion-item class="item">\n          <ion-label floating>Libelle</ion-label>\n          <ion-input  type="text" name="name"  [(ngModel)]="p.name" required="" ></ion-input>\n      </ion-item>\n      <ion-item>\n          <ion-label floating>Description</ion-label>\n          <ion-textarea   type="" name="description"  [(ngModel)]="p.description" required="" ></ion-textarea >\n      </ion-item>\n      <ion-item>\n          <ion-label floating>Prix</ion-label>\n          <ion-input  type="number" name="price"  [(ngModel)]="p.price"   required="" ></ion-input>\n      </ion-item>\n      <ion-item *ngIf="this.mineStat" >\n          <ion-label>Photo</ion-label>\n              \n          </ion-item>\n          <div class="divPhoto" *ngIf="this.mineStat">\n              <img src="{{mine}}"/>\n          </div>\n          \n      <ion-item>\n          <ion-label class="item">Promotion</ion-label>\n          <ion-checkbox name="onSale" [(ngModel)]="p.onSale" checked="p.onSale"  (click)="onSale()" ></ion-checkbox>\n      </ion-item>\n      <div *ngIf="p.onSale">\n      <ion-item >\n          <ion-label floating>Nouveau</ion-label>\n          <ion-input type="number" name="priceOnSale"  [(ngModel)]="p.priceOnSale"  required="" ></ion-input>\n      </ion-item>\n      <ion-item >\n          <ion-label floating>Debut</ion-label>\n          <ion-datetime displayFormat="MMM DD, YYYY" name="startDate" [(ngModel)]="p.startDate"  ></ion-datetime>\n      </ion-item>\n      <ion-item >\n              <ion-label floating>fin</ion-label>\n          <ion-datetime   displayFormat="MMM DD, YYYY" name="endDate"  [(ngModel)]="p.endDate"  ></ion-datetime>\n      </ion-item>\n      </div>\n      \n              \n          <br><br>\n      <button class="btnt" ion-button="" type="submit"  block="" [disabled]="!f.valid">Ajouter</button>\n    </form>\n</ion-content>\n    \n\n<ion-content *ngIf="id==4" overflow-scroll="true" padding class="cakebg">\n    <form #f="ngForm" class="login-box" (ngSubmit)="onAddSnack(f.value)">\n        <ion-item class="item">\n            <ion-label floating>Libelle</ion-label>\n            <ion-input  type="text" name="name"  [(ngModel)]="p.name" required="" ></ion-input>\n        </ion-item>\n        <ion-item>\n            <ion-label floating>Description</ion-label>\n            <ion-textarea   type="" name="description"  [(ngModel)]="p.description" required="" ></ion-textarea >\n        </ion-item>\n        <ion-item>\n            <ion-label floating>Prix</ion-label>\n            <ion-input  type="number" name="price"  [(ngModel)]="p.price"   required="" ></ion-input>\n        </ion-item>\n        <ion-item *ngIf="this.mineStat==true">\n            <ion-label>Photo</ion-label>\n            <div class="divPhoto" >\n                <img src="{{mine}}"/>\n            </div>\n        </ion-item>  \n            \n        <ion-item>\n            <ion-label class="item">Promotion</ion-label>\n            <ion-checkbox name="onSale" [(ngModel)]="p.onSale" checked="p.onSale"  (click)="onSale()" ></ion-checkbox>\n        </ion-item>\n        <div *ngIf="p.onSale">\n        <ion-item >\n            <ion-label floating>Nouveau</ion-label>\n            <ion-input type="number" name="priceOnSale"  [(ngModel)]="p.priceOnSale"  required="" ></ion-input>\n        </ion-item>\n        <ion-item >\n            <ion-label floating>Debut</ion-label>\n            <ion-datetime displayFormat="MMM DD, YYYY" name="startDate" [(ngModel)]="p.startDate"  ></ion-datetime>\n        </ion-item>\n        <ion-item >\n                <ion-label floating>fin</ion-label>\n            <ion-datetime   displayFormat="MMM DD, YYYY" name="endDate"  [(ngModel)]="p.endDate"  ></ion-datetime>\n        </ion-item>\n        </div>\n        \n                \n            <br><br>\n        <button class="btnt" ion-button="" type="submit"  block="" [disabled]="!f.valid">Ajouter</button>\n      </form>\n  </ion-content>\n\n  <ion-content *ngIf="id==5" overflow-scroll="true" padding class="bgSnacks">\n    <form #f="ngForm" class="login-box" (ngSubmit)="onAddViennoiserie(f.value)">\n        <ion-item class="item">\n            <ion-label floating>Libelle</ion-label>\n            <ion-input  type="text" name="name"  [(ngModel)]="p.name" required="" ></ion-input>\n        </ion-item>\n        <ion-item>\n            <ion-label floating>Description</ion-label>\n            <ion-textarea   type="" name="description"  [(ngModel)]="p.description" required="" ></ion-textarea >\n        </ion-item>\n        <ion-item>\n            <ion-label floating>Prix</ion-label>\n            <ion-input  type="number" name="price"  [(ngModel)]="p.price"   required="" ></ion-input>\n        </ion-item>\n        <ion-item *ngIf="this.mineStat==true">\n            <ion-label>Photo</ion-label>\n            <div class="divPhoto" >\n                <img src="{{mine}}"/>\n            </div>\n        </ion-item>  \n            \n        <ion-item>\n            <ion-label class="item">Promotion</ion-label>\n            <ion-checkbox name="onSale" [(ngModel)]="p.onSale" checked="p.onSale"  (click)="onSale()" ></ion-checkbox>\n        </ion-item>\n        <div *ngIf="p.onSale">\n        <ion-item >\n            <ion-label floating>Nouveau</ion-label>\n            <ion-input type="number" name="priceOnSale"  [(ngModel)]="p.priceOnSale"  required="" ></ion-input>\n        </ion-item>\n        <ion-item >\n            <ion-label floating>Debut</ion-label>\n            <ion-datetime displayFormat="MMM DD, YYYY" name="startDate" [(ngModel)]="p.startDate"  ></ion-datetime>\n        </ion-item>\n        <ion-item >\n                <ion-label floating>fin</ion-label>\n            <ion-datetime   displayFormat="MMM DD, YYYY" name="endDate"  [(ngModel)]="p.endDate"  ></ion-datetime>\n        </ion-item>\n        </div>\n        \n                \n            <br><br>\n        <button class="btnt" ion-button="" type="submit"  block="" [disabled]="!f.valid">Ajouter</button>\n      </form>\n  </ion-content>'/*ion-inline-end:"C:\Users\ghofrane\Desktop\ionicTest\MyCampus-master\MyCampus-master\src\pages\cafeteria\form-drinks\form-drinks.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__servicesCafeteria_product_list_product_list_service__["a" /* ProductListService */],
            __WEBPACK_IMPORTED_MODULE_3__servicesCafeteria_toast_service__["a" /* ToastService */], __WEBPACK_IMPORTED_MODULE_4__ionic_native_camera__["a" /* Camera */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */]])
    ], FormDrinksPage);
    return FormDrinksPage;
}());

//# sourceMappingURL=form-drinks.js.map
