...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__canteen_home__ = __webpack_require__(910);
...
var CanteenHomePage = (function () {
    function CanteenHomePage(navCtrl, navParams, events, reservationservice, toast, loadingCtrl, mealservice) {
        ...
        this.reserveliste$.subscribe(function (value) {
            ...
            for (var _i = 0, _a = _this.demo; _i < _a.length; _i++) {
                var element = _a[_i];
                if (element.toString().startsWith("Sun", 0) == false) {
                    _this.datesreserve[compteur] = 0;
                    dayte = element.getDate() + "/" + (element.getMonth() + 1) + "/" + element.getFullYear();
                    _this.dates.push(dayte);
                    for (var _b = 0, _c = _this.reservations; _b < _c.length; _b++) {
                        var elem = _c[_b];
        ...
        this.mealList$.subscribe(function (value) {
            ...
            for (km = 0; km < 30; km++) {
                ...
                if (_this.comentdate[km].toString().startsWith("Sun", 0) == false) {
                    for (var _i = 0, _a = _this.meals; _i < _a.length; _i++) {
                        var element = _a[_i];
                        if ((new Date(element.date).getFullYear() == _this.comentdate[km].getFullYear())
                            && (new Date(element.date).getMonth() == _this.comentdate[km].getMonth())
                            && (new Date(element.date).getDate() == _this.comentdate[km].getDate())) {
                            sum = 0;
                            i = 0;
                            ...
                            if (km == 12) {
                                _this.commentnbr[1] += element.moyennefeed;
                            }
                            else {
                                if (km == 17) {
                                    _this.commentnbr[2] += element.moyennefeed;
                                }
                                else {
                                    _this.commentnbr[((km / 7) - ((km % 7) / 7))] += element.moyennefeed;
                                }
                            }
                        }
                    }
                ...
                if (cont != 0) {
                    if (km == 6) {
                        _this.commentnbr[0] = _this.commentnbr[0] / cont;
                        cont = 0;
                    }
                    if (km == 13) {
                        _this.commentnbr[1] = _this.commentnbr[1] / cont;
                        cont = 0;
                    }
                    if (km == 20) {
                        _this.commentnbr[2] = _this.commentnbr[2] / cont;
                        cont = 0;
                    }
                    if (km == 27) {
                        _this.commentnbr[3] = _this.commentnbr[3] / cont;
                        cont = 0;
                    }
                }
            }
            for (km = 0; km < 4; km++) {
                _this.commentnbr[km] = _this.commentnbr[km];
            }
            console.log(_this.commentnbr);
            _this.commentchart();
        });
        loading.dismiss();
    }
    CanteenHomePage.prototype.commentchart = function () {
...
*/
    ...
    CanteenHomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-canteen-home',template:/*ion-inline-start:"C:\Users\ghofrane\Desktop\ionicTest\MyCampus-master\MyCampus-master\src\pages\canteen\canteen-home\canteen-home.html"*/'<ion-header>\n\n    <ion-navbar hideBackButton color="primary">\n\n        \n        <button ion-button icon-only menuToggle>\n            <ion-icon name="menu"></ion-icon>\n        </button>\n\n        <ion-title>Restaurant</ion-title>\n        \n    </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding class="back">\n\n        \n\n        <ion-card>\n                <ion-card-header>\n                  Reservation par jour (dernier semaine)\n                </ion-card-header>\n                <ion-card-content>\n                  <canvas #barCanvas></canvas>\n                </ion-card-content>\n        </ion-card>\n        \n        <ion-card>\n                <ion-card-header>\n                  Evolution commentaire par mois\n                </ion-card-header>\n                <ion-card-content>\n                    <canvas id="rate-chart"></canvas>\n                </ion-card-content>\n        </ion-card>\n\n        \n\n</ion-content>'/*ion-inline-end:"C:\Users\ghofrane\Desktop\ionicTest\MyCampus-master\MyCampus-master\src\pages\canteen\canteen-home\canteen-home.html"*/,
        }),
