...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViennoiseriePageModule", function() { return ViennoiseriePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__viennoiserie__ = __webpack_require__(908);
...
var ViennoiseriePageModule = (function () {
    function ViennoiseriePageModule() {
    }
    ViennoiseriePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__viennoiserie__["a" /* ViennoiseriePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__viennoiserie__["a" /* ViennoiseriePage */]),
            ],
        })
    ], ViennoiseriePageModule);
    return ViennoiseriePageModule;
}());

//# sourceMappingURL=viennoiserie.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ViennoiseriePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
...
/**
 * Generated class for the ViennoiseriePage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var ViennoiseriePage = (function () {
    function ViennoiseriePage(navCtrl, navParams, product, toast, camera, events) {
    ...
    ViennoiseriePage.prototype.setupSideMenuContent = function () {
        this.events.publish('sideMenu:changeContent', this.sideMenuContent);
    };
    ViennoiseriePage.prototype.ngOnInit = function () {
        var _this = this;
        this.length = 0;
        this.fab = false;
        this.sale = false;
        this.product
            ...
            for (var i = 0; i < _this.products.length; i++) {
                if (_this.products[i].category !== "autre" || _this.products[i].type !== "viennoiserie") {
    ...
    ViennoiseriePage.prototype.accordionClick = function (event, index, p) {
        console.log(event);
        console.log(index);
        if (p.photo !== null) {
            this.photo = p.photo;
    ...
    ViennoiseriePage.prototype.ionViewDidLoad = function () {
    };
    ViennoiseriePage.prototype.onNewItem = function (id) {
        this.navCtrl.push("FormDrinksPage", { id: id });
    };
    ViennoiseriePage.prototype.toggleGroup = function (group) {
    ...
    ;
    ViennoiseriePage.prototype.isGroupShown = function (group) {
        return this.shownGroup === group;
    };
    ;
    ViennoiseriePage.prototype.testfab = function () {
        this.fab = !this.fab;
    };
    ViennoiseriePage.prototype.onRemove = function (p) {
        var _this = this;
        this.product.remove(p).then(function () {
            _this.toast.show(p.name + " supprime avec succes!");
            _this.navCtrl.setRoot('ViennoiseriePage');
        });
    };
    ViennoiseriePage.prototype.onSale = function () {
        this.sale = !this.sale;
        console.log('Cucumbers new state:' + this.promotion);
    };
    ViennoiseriePage.prototype.takePic = function () {
        var _this = this;
        var options1 = {
            quality: 100,
    ...
    return ViennoiseriePage;
}());

//# sourceMappingURL=viennoiserie.js.map
