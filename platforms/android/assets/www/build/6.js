...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WaterPageModule", function() { return WaterPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__water__ = __webpack_require__(909);
...
var WaterPageModule = (function () {
    function WaterPageModule() {
    }
    WaterPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__water__["a" /* WaterPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__water__["a" /* WaterPage */]),
            ],
        })
    ], WaterPageModule);
    return WaterPageModule;
}());
...
var WaterPage = (function () {
    function WaterPage(navCtrl, navParams, product, toast, camera, events) {
    ...
    WaterPage.prototype.setupSideMenuContent = function () {
        this.events.publish('sideMenu:changeContent', this.sideMenuContent);
    };
    WaterPage.prototype.ngOnInit = function () {
        var _this = this;
        this.length = 0;
        this.fab = false;
        this.sale = false;
        this.product
            ...
            for (var i = 0; i < _this.products.length; i++) {
                if (_this.products[i].category !== "boissons" || _this.products[i].type !== "water") {
    ...
    WaterPage.prototype.accordionClick = function (event, index, p) {
        console.log(event);
        console.log(index);
        if (p.photo !== null) {
            this.photo = p.photo;
    ...
    WaterPage.prototype.onNewItem = function (id) {
        this.navCtrl.push("FormDrinksPage", { id: id });
    };
    WaterPage.prototype.toggleGroup = function (group) {
    ...
    ;
    WaterPage.prototype.isGroupShown = function (group) {
        return this.shownGroup === group;
    };
    ;
    WaterPage.prototype.testfab = function () {
        this.fab = !this.fab;
    };
    WaterPage.prototype.onRemove = function (p) {
        var _this = this;
        this.product.remove(p).then(function () {
            _this.toast.show(p.name + " supprime avec succes!");
            _this.navCtrl.setRoot('WaterPage');
        });
    };
    WaterPage.prototype.onSale = function () {
        this.sale = !this.sale;
        console.log('Cucumbers new state:' + this.promotion);
    };
    WaterPage.prototype.takePic = function () {
        var _this = this;
        var options1 = {
            quality: 100,
        ...
        this.camera.getPicture(options1)
            ...
            __WEBPACK_IMPORTED_MODULE_5_firebase___default.a.storage().ref("product/boissons/water/" + filename + ".jpg").putString(_this.photo, 'data_url').then(function (img) { _this.mine = img.downloadURL; });
        });
        this.photo = this.mine;
    };
    WaterPage.prototype.onEditItem = function (p) {
        if (this.photo != null) {
            p.photo = this.photo;
        }
